...
// ---------------------------------------------------------------------------
// Seed script — real Talentbank 2026 career fairs, shaped for a live demo.
...
//
// "Today" for the demo is 2026-07-28, so anything ending before that shows as
// Past. Dates are plain "YYYY-MM-DD" strings — never new Date("YYYY-MM-DD").
// ---------------------------------------------------------------------------
